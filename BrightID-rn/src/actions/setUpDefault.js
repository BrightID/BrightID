			...
			allConnections(
				fromJS([
					...
					},
					{
						...
						lastName: "Zanetto",
						avatar:
							"https://robohash.org/nemovelvelit.bmp?size=145x145&set=set1",
					...
					},
					{
						...
						lastName: "Paolacci",
						avatar:
							"https://robohash.org/totameterror.jpg?size=145x145&set=set1",
					...
					},
					{
						...
						lastName: "Skalls",
						avatar:
							"https://robohash.org/utminimaeos.bmp?size=145x145&set=set1",
					...
					},
					{
						...
						lastName: "Cesconi",
						avatar:
							"https://robohash.org/odionobiseum.png?size=145x145&set=set1",
					...
					},
					{
						...
						lastName: "Lovat",
						avatar:
							"https://robohash.org/eosinplaceat.png?size=145x145&set=set1",
					...
					},
					{
						...
						lastName: "Mansfield",
						avatar:
							"https://robohash.org/numquamnonet.bmp?size=145x145&set=set1",
					...
					},
					{
						...
						lastName: "Brear",
						avatar:
							"https://robohash.org/quisautsint.png?size=145x145&set=set1",
