...
BrightID uses the people you know (a social graph) to keep out duplicates and enforce one-user-per-person for important applications like voting and universal basic income.
