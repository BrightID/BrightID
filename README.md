...
There are several kinds of apps that work better when every user in the system is a unique person.  When you authorize an app with BrightID, you allow it to check your ID and see that you're unique.  No personal information needs to be shared.
