...
There are several kinds of apps that work better when everyone in the system is unique.  You can authorize these apps to use BrightID to verify that you're unique without sharing any personal information.  In some cases, a BrightID can even be used to register instead of a name, email address, phone number, or other identifying information.
