...
let globalNodeApi: NodeApi | null = null;
export const getGlobalNodeApi = () => globalNodeApi;

export const NodeApiContextProvider = (
...
export const useNodeApiContext = () => {
  const context = useContext(NodeApiContext);
  if (context === null) {
    throw new Error(
      'NodeApiContext must be used within a NodeApiContextProvider',
    );
  }
  return context;
};
